...
<header id="header" role="banner" class="clearfix">
    ...
    <!-- Auto Populate Div Start -->
		<div id="auto-popup" tabindex="0">
			<button id="closeButton">X</button><br>
			...
			<center>
				<h3>Subscribe</h3>
				<p>To get best of our latest Deals</p>
			</center>
			<div id="subs-div">
				<?php
					$block = module_invoke('simplenews', 'block_view', '43');
					print render($block['content']);
				?>
			</div>
			<!-- JS for closing popup form start -->
			<script>
				setInterval("$('#auto-popup').toggle();",2000);
				...
				function dontShow(){
					...
					document.cookie = "popup-visited=yes";
				}
			</script>
			<!-- JS for closing popup form ends -->
			<a id="noShow" href="javascript:dontShow()">Don't show this again</a>
		</div>
		<!-- Auto Populate Div Ends -->
  ...
  <div class="container">
    <div class="row"><div class="col-md-12">
      <div id="search-region" class="clearfix">
        ...
        <?php endif; ?>
         <div id="home-link" style="font-size:2.6em; float:left; margin-top:18px;color:grey; padding-left:5px;">
            <a href="<?php echo $base_url; ?>" title="Home" style="color:#fff212;"><i class="fa fa-home" aria-hidden="true"></i></a>
        </div>
        <!-- custom dropdown menu -->
		<div id="logo-dropdown"">
			<a herf="#" style="color:#fff212;"><strong>&#9776;</strong></a>
			<div class="top-arrow-logo"></div>
			<div id="logo-dropdown-menu">
				<ul id="dropdown-1">
					<li><a href="/about-us" class="leaf">About Us</a></li>
					<li><a href="/blog">Blog</a></li>
					<li><a href="/contact">Contact</a></li>
					<li><a href="/vendor-contact">Sell on SmartSavz</a></li>
					<li id="app-download-link">Download App<img src='https://chart.googleapis.com/chart?cht=qr&chl=http%3A%2F%2Fsavz.flatsguru.com%2F&chs=180x180&choe=UTF-8&chld=L|2' alt='qr code'><a href='http://www.qrcode-generator.de' border='0' style='cursor:default'  rel='nofollow'></a><br></li>
				</ul>
				<ul id="dropdown-2">
					<li class="left"><a href="#"><i class="fa fa-facebook"></i></a></li>
					<li class="left"><a href="#" title="Twitter"><i class="fa fa-twitter"></i></a></li>
					<li class="left"><a href="#" title="Google Plus"><i class="fa fa-google-plus"></i></a></li>
				</ul>
			</div>
        </div>
       
        <div id="show-cat-div">
            <a href="" id="cat-text">Product Category</a>
            <div class="top-arrow-cat"></div>
            <div id="cat-list">
                <ul>
                    <?php 
                        global $base_url;
                        $val =  taxonomy_get_tree(2); // loading business category taxonomy
                        foreach($val as $v){
                            $tid = $v->tid;
                            $name = $v->name;
                            $url = $base_url.url('taxonomy/term/'.$tid);
                            echo '<li><a href="'.$url.'">'.$name.'</a><br></li>';
                        }
                    ?>
                </ul>
            </div>
        </div>
		<!-- custom dropdown menu ends -->
        <?php if ($page['search']) :?>        
